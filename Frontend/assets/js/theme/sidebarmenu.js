...
if (currentURL.includes("https://bootstrapdemos.adminmart.com/main/index.html")) {
  link.setAttribute("href", "index-2.html");
} else if (currentURL.includes("https://bootstrapdemos.adminmart.com/index.html")) {
  link.setAttribute("href", "index-2.html");
} else {
